module uart (DATA_IN_Rx,
 ...
 wire net32;
 wire net33;
 wire clknet_1_0__leaf_clk_CPU;
 wire clknet_1_1__leaf_clk_CPU;
 ...
 sky130_fd_sc_hd__dfrtp_4 _349_ (.CLK(net31),
    ...
    .RESET_B(net11),
    .Q(\uart3.state[3] ));
 sky130_fd_sc_hd__dfrtp_4 _350_ (.CLK(clknet_1_0__leaf_clk_CPU),
    .D(_000_),
    .RESET_B(net11),
    .Q(net31));
 sky130_fd_sc_hd__dfrtp_1 _351_ (.CLK(clknet_1_1__leaf_clk_CPU),
    .D(_001_),
    .RESET_B(net11),
    .Q(net26));
 sky130_fd_sc_hd__dfrtp_1 _352_ (.CLK(clknet_1_1__leaf_clk_CPU),
    .D(_002_),
    .RESET_B(net11),
    .Q(net25));
 sky130_fd_sc_hd__dfrtp_1 _353_ (.CLK(clknet_1_1__leaf_clk_CPU),
    .D(_003_),
    .RESET_B(net11),
    .Q(net24));
 sky130_fd_sc_hd__dfrtp_1 _354_ (.CLK(clknet_1_1__leaf_clk_CPU),
    .D(_004_),
    .RESET_B(net11),
    .Q(net23));
 sky130_fd_sc_hd__dfstp_1 _355_ (.CLK(clknet_1_1__leaf_clk_CPU),
    .D(_005_),
    .SET_B(net11),
    .Q(net19));
 sky130_fd_sc_hd__dfrtp_1 _356_ (.CLK(clknet_1_1__leaf_clk_CPU),
    .D(_006_),
    .RESET_B(net11),
    .Q(net20));
 ...
 sky130_fd_sc_hd__dfstp_1 _361_ (.CLK(net31),
    ...
    .SET_B(net11),
    .Q(net27));
 sky130_fd_sc_hd__dfrtp_1 _362_ (.CLK(clknet_1_0__leaf_clk_CPU),
    .D(_008_),
    .RESET_B(net11),
    .Q(\uart1.counter[0] ));
 sky130_fd_sc_hd__dfrtp_2 _363_ (.CLK(clknet_1_0__leaf_clk_CPU),
    .D(_009_),
    .RESET_B(net11),
    .Q(\uart1.counter[1] ));
 sky130_fd_sc_hd__dfrtp_1 _364_ (.CLK(clknet_1_0__leaf_clk_CPU),
    .D(_010_),
    .RESET_B(net11),
    .Q(\uart1.counter[2] ));
 sky130_fd_sc_hd__dfrtp_4 _365_ (.CLK(clknet_1_0__leaf_clk_CPU),
    .D(_011_),
    .RESET_B(net11),
    .Q(\uart1.counter[3] ));
 sky130_fd_sc_hd__dfrtp_1 _366_ (.CLK(clknet_1_0__leaf_clk_CPU),
    .D(_012_),
    .RESET_B(net11),
    .Q(\uart1.counter[4] ));
 sky130_fd_sc_hd__dfrtp_2 _367_ (.CLK(clknet_1_1__leaf_clk_CPU),
    .D(_013_),
    .RESET_B(net11),
    .Q(\uart1.counter[5] ));
 sky130_fd_sc_hd__dfrtp_2 _368_ (.CLK(clknet_1_0__leaf_clk_CPU),
    .D(_014_),
    .RESET_B(net11),
    .Q(\uart1.counter[6] ));
 sky130_fd_sc_hd__dfrtp_2 _369_ (.CLK(clknet_1_0__leaf_clk_CPU),
    .D(_015_),
    .RESET_B(net11),
    .Q(\uart1.counter[7] ));
 sky130_fd_sc_hd__dfrtp_2 _370_ (.CLK(clknet_1_1__leaf_clk_CPU),
    .D(_016_),
    .RESET_B(net11),
    .Q(\uart1.counter[8] ));
 sky130_fd_sc_hd__dfrtp_1 _371_ (.CLK(clknet_1_1__leaf_clk_CPU),
    .D(_017_),
    .RESET_B(net11),
    .Q(\uart1.counter[9] ));
 sky130_fd_sc_hd__dfrtp_1 _372_ (.CLK(clknet_1_1__leaf_clk_CPU),
    .D(_018_),
    .RESET_B(net11),
    .Q(net28));
 sky130_fd_sc_hd__dfrtp_1 _373_ (.CLK(net31),
    ...
    .RESET_B(net11),
    .Q(net29));
 sky130_fd_sc_hd__dfrtp_1 _374_ (.CLK(clknet_1_1__leaf_clk_CPU),
    .D(_020_),
    .RESET_B(net11),
    .Q(net21));
 sky130_fd_sc_hd__dfrtp_1 _375_ (.CLK(clknet_1_1__leaf_clk_CPU),
    .D(_021_),
    .RESET_B(net11),
    .Q(net22));
 ...
 sky130_fd_sc_hd__clkbuf_1 _378_ (.A(net28),
    .X(net30));
 sky130_fd_sc_hd__clkbuf_16 clkbuf_0_clk_CPU (.A(clk_CPU),
    .X(clknet_0_clk_CPU));
 ...
 sky130_fd_sc_hd__clkbuf_16 clkbuf_1_0__f_clk_CPU (.A(clknet_0_clk_CPU),
    .X(clknet_1_0__leaf_clk_CPU));
 sky130_fd_sc_hd__clkbuf_16 clkbuf_1_1__f_clk_CPU (.A(clknet_0_clk_CPU),
    .X(clknet_1_1__leaf_clk_CPU));
 ...
 sky130_fd_sc_hd__decap_8 FILLER_0_1_148 ();
 sky130_fd_sc_hd__decap_3 FILLER_0_1_156 ();
 ...
 sky130_fd_sc_hd__decap_4 FILLER_0_2_148 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_0_3_132 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_0_6_146 ();
 ...
 sky130_fd_sc_hd__decap_3 FILLER_0_8_113 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_0_9_65 ();
 sky130_fd_sc_hd__decap_6 FILLER_0_9_101 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_0_11_70 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_0_16_149 ();
 ...
 sky130_fd_sc_hd__decap_3 FILLER_0_19_156 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_0_20_58 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_0_21_10 ();
 ...
 sky130_fd_sc_hd__decap_3 FILLER_0_23_74 ();
 ...
 sky130_fd_sc_hd__decap_4 FILLER_0_24_45 ();
