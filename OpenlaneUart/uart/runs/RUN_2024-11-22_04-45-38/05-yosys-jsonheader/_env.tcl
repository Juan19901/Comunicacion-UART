set ::env(_DEPS_SCRIPT) /foss/designs/uart/runs/RUN_2024-11-22_04-45-38/05-yosys-jsonheader/_deps.tcl
...
set ::env(VERILOG_FILES) "/foss/designs/uart/src/uart.v /foss/designs/uart/src/tx.v /foss/designs/uart/src/rx.v /foss/designs/uart/src/bitrate.v"
set ::env(VERILOG_POWER_DEFINE) USE_POWER_PINS
set ::env(USE_SYNLIG) 0
set ::env(SYNLIG_DEFER) 0
set ::env(SAVE_JSON_HEADER) /foss/designs/uart/runs/RUN_2024-11-22_04-45-38/05-yosys-jsonheader/uart.h.json
